(function ($) {
  ...
  $(window).resize(function () {
    ...
    if (windowWidth <= 974) {
      ...
      $('.local-scroll.desktop-offset-0').localScroll({
        offset: {
          top: -60
        },
        duration: 1500,
      ...
      $('.local-scroll.mobile-offset-0').localScroll({
        offset: {
          top: 0
        },
        duration: 1500,
    ...
    if (windowWidth > 974 & $('html').hasClass('mobile')) {
      $('.navbar-nav > li.dropdown > a, .dropdown-submenu > a').on('click', function (e) {
        e.preventDefault();
      });
    }
  ...
  function initMasonry() {
    ...
    $masonry.imagesLoaded(function () {
      $masonry.isotope({
        ...
        isResizeBound: false,
        masonry: {
          columnWidth: '.masonry-item.quarter'
        }
      });
    });
